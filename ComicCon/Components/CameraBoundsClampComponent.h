...
{
    TopDown     UMETA(DisplayName = "TopDown (look -Z, clamp in XY)"),
    SideScroller UMETA(DisplayName = "SideScroller (look -X, clamp in YZ)")
};

UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class COMICCON_API UCameraBoundsClampComponent : public UActorComponent
{
    GENERATED_BODY()
